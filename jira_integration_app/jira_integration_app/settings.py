...
# Scrum update settings
SCRUM_UPDATE_REMINDER_HOUR = int(os.getenv('SCRUM_UPDATE_REMINDER_HOUR', 10))  # 10 AM
SCRUM_UPDATE_REMINDER_MINUTE = int(os.getenv('SCRUM_UPDATE_REMINDER_MINUTE', 0))  # 00 minutes
